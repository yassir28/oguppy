...
export default function Navbar() {
  ...
  return (
    <>
      <header className="bg-blue-500 fixed top-0 right-0 w-full left-0 h-16 flex items-center justify-between px-16 text-slate-50 z-50">
        ...
        {status === "authenticated" ? (
          ...
          <div className="hidden sm:flex items-center gap-4">
            ...
            <ThemeLink
              className="bg-rose-400 hover:bg-rose-500 focus:ring-rose-100 "
              title="Register"
              href="/register"
            /> 
