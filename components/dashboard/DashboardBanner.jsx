...
export default function DashboardBanner() {
    ...
    return (
        <div className={`${hidden?"hidden":'hidden lg:grid grid-cols-12 gap-3 items-center py-6 px-16 bg-white gap-4 relative'}`}>
            {/* Icon */}
            ...
            <div className="col-span-6">
                ...
                <p> Businesses are moving towards online payments as theyre easy, secure and fast. Try them for your business today</p>
            </div>
            {/* button */}
