...
// app/(back-office)/side-bar/documents/page.jsx
"use client"

import { useState, useEffect } from 'react'
import { MessageSquare, FileText, Users, DollarSign, TrendingUp } from 'lucide-react'
            ...
            <div className="grid grid-cols-2 gap-2 mb-3">
              {[
                ...
                <button
                  ...
                  className="text-left text-xs px-3 py-2 rounded bg-gray-100 hover:bg-gray-200 text-gray-700"
